        ...
        <div className="flex flex-col w-full gap-8">
          ...
          <div className="w-full flex gap-10">
            <div className="w-[70%]">
              <h3>Raphael. Lee</h3>
              <p className="text-pace-stone-500  leading-relaxed">
                I&apos;ve bee managing multicultural teams for ever 19 years.
                And blesses to lead and be part of the opening teams in global
                projects in various countries. Growing personal & professional
                goals by sharing visions with teammates became a part of my
                passion and a long-term goal in my life.
              </p>
              <div className="mt-6">
                ...
                <table className="w-full">
                  <tbody className="text-pace-stone-500">
                    <tr>
                      <td className="py-1 pr-4">2019 ~</td>
                      <td className="py-1">Managing Director at Pacemaker</td>
                    </tr>
                    <tr>
                      <td className="py-1 pr-4">2015 ~ 2019</td>
                      <td className="py-1">
                        Director of Operations at Metanet
                      </td>
                    </tr>
                    <tr>
                      <td className="py-1 pr-4">2009 ~ 2014</td>
                      <td className="py-1">
                        Business Development Manager at People In Biz Corp.
                      </td>
                    </tr>
                    <tr>
                      <td className="py-1 pr-4">2004 ~ 2008</td>
                      <td className="py-1">
                        Purchaser at InterContinental Hotels Group
                      </td>
                    </tr>
                  </tbody>
                </table>
