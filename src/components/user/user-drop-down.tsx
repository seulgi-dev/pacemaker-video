    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 rounded-2xl border border-gray-200 bg-white shadow-md z-50 items-center">
          <Link
            href="/mypage"
            className={`block w-[122px] h-12 pt-4 pb-2 px-6 text-base font-normal hover:bg-gray-100 rounded-xl text-center ${
              pathname === '/mypage'
          ...
          <Link
            ...
            className={`block w-[122px] h-12 pt-2 px-6 text-base font-normal hover:bg-gray-100 rounded-xl text-center ${
              pathname === '/mypage/purchases'
                ? 'text-pace-orange-800'
                : 'text-pace-stone-500'
            }`}
            onClick={() => setIsOpen(false)}
